...
const account3 = {
  owner: 'Taras Shevchenko',
  movements: [-642.21, -133.9, 79.97, 1300, 1300, 800, -100, 322],
  interestRate: 1.2, // %
  pin: 3333,
...
const account4 = {
  ...
  movements: [5000, 3400, -150, -790, 222, 444, 550, -40],
  interestRate: 1.5,
  pin: 4444,
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    labelWelcome.textContent = `Welcome back, ${currentAccount.owner.concat()}`;
